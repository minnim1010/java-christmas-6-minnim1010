...
public class MenuCategoryAmountDiscount implements AmountDiscountType {
    private final MenuCategory menuCategory;
    private final Money discountAmountPerMenu;

    public MenuCategoryAmountDiscount(MenuCategory menuCategory, Money discountAmountPerMenu) {
